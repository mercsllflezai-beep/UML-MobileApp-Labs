...
| `component-diagram.plantuml` | PlantUML код компонентов |
| `object-diagram.png` | Диаграмма объектов |
| `object-diagram.plantuml` | PlantUML код объектов |
| `use-case-diagram.png` | Диаграмма вариантов использования |
| `use-case-diagram.plantuml` | PlantUML код вариантов использования |
| `deployment-diagram.png` | Диаграмма развёртывания |
| `deployment-diagram.plantuml` | PlantUML код развёртывания |
